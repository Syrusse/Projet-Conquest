...
class GameTest {
    ...
    void TEST() {
        // Create predefined game
        Pawn[][] field = new Pawn[7][7];
        Board board = new Board(field);
        Game game = new Game(board, null, null, null, null);
        Player player1 = game.getPlayers()[0];
        Player player2 = game.getPlayers()[1];
        //field[0][0] = new Pawn(player2);
        field[6][6] = new Pawn(player2);
    ...
    void TEST2() {
        ...
        Board board = new Board(field);
        Game game = new Game(board, new Naive(), name1, minmax, name2);

        Player player1 = game.getPlayers()[0];
        Player player2 = game.getPlayers()[1];

        //game.getBoard().initField(player1,player2);

        field[0][0] = new Pawn(player2);
        field[1][1] = new Pawn(player1);
        field[2][2] = new Pawn(player1);

        /*field[4][0] = new Pawn(player1);
        field[1][1] = new Pawn(player2);
        field[2][1] = new Pawn(player2);
        field[2][2] = new Pawn(player2);
        ...
        System.out.println(game.getBoard().toString());
        System.out.println(minmax.getMove(game.getBoard(),  player2));
